...
function installForClaude(apiKey: string): InstallationResult {
  try {
    ...
    return { client: 'Claude Desktop', success: false, message: error instanceof Error ? error.message : 'Unknown error' };
  }
}
...
function installForCursor(apiKey: string): InstallationResult {
  try {
    ...
    return { client: 'Cursor (Cline)', success: false, message: error instanceof Error ? error.message : 'Unknown error' };
  }
}
...
function installForWindsurf(apiKey: string): InstallationResult {
  try {
    ...
    return { client: 'Windsurf', success: false, message: error instanceof Error ? error.message : 'Unknown error' };
  }
}
...
function installForContinue(apiKey: string): InstallationResult {
  try {
    ...
    return { client: 'Continue.dev', success: false, message: error instanceof Error ? error.message : 'Unknown error' };
  }
}
...
function installForVSCode(apiKey: string): InstallationResult {
  try {
    ...
    return { client: 'VS Code', success: false, message: error instanceof Error ? error.message : 'Unknown error' };
  }
}
...
function installForZed(apiKey: string): InstallationResult {
  try {
    ...
    return { client: 'Zed Editor', success: false, message: error instanceof Error ? error.message : 'Unknown error' };
  }
}
  ...
  const validateApiKey = async (key: string) => {
    ...
    try {
      ...
      if (err instanceof LeadMagicError && (err.isClientError())) {
        ...
        setError('Could not connect to LeadMagic. Please check your network.');
      }
    } finally {
